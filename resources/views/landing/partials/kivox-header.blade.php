...
<header>
  <nav class="nav">
    <a class="logo" href="/" aria-label="KIVOX"><img src="https://kivox.co/storage/plataforma/plataforma-logo-1779417616.png" alt="KIVOX" onerror="this.outerHTML='<span style=&quot;width:52px;height:52px;border-radius:12px;background:#0EA26B;display:grid;place-items:center;font-weight:800;color:#fff;font-size:26px&quot;>K</span>'"></a>
    <div class="nav-links">
