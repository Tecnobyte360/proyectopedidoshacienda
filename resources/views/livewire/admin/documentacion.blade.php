            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-white/90">
                        Cómo está construida la plataforma TecnoByte360 SaaS — referencia interna para el dueño de la plataforma.
                    </p>
                    <div class="mt-3 inline-flex items-center gap-2 bg-white/15 backdrop-blur rounded-full px-3 py-1 text-xs font-semibold">
                        <i class="fa-solid fa-lock"></i> Solo visible para super-admin desde el dominio principal
                    </div>
                </div>
            </div>
        </div>
...
class Pedido extends Model
{
    use BelongsToTenant;   // ← inyecta tenant_id en create() + filtra en read()
            ...
            <pre class="bg-slate-900 text-orange-200 text-xs p-3 rounded-lg overflow-auto"><code>app(\App\Services\TenantManager::class)->withoutTenant(function () {
        ...
        <section id="subdominios" class="rounded-2xl bg-white border border-slate-200 p-6 space-y-3">
            ...
            <div class="space-y-3 mt-3">
                ...
                <div class="rounded-xl border border-orange-200 bg-gradient-to-r from-orange-50 to-amber-50 p-4">
                    ...
                    <ol class="text-xs text-slate-700 list-decimal pl-5 mt-1 space-y-0.5">
            ...
            <pre class="bg-slate-900 text-orange-200 text-xs p-3 rounded-lg overflow-auto"><code>HOSTINGER_API_KEY=XcVK...
...
CERTBOT_EMAIL=comercial@tecnobyte360.com</code></pre>
  ...
  "connection_ids": [15, 28]
        ...
        <section id="ops" class="rounded-2xl bg-white border border-slate-200 p-6 space-y-3">
            ...
            <pre class="bg-slate-900 text-orange-200 text-xs p-3 rounded-lg overflow-auto"><code># Estado
...
sudo tail -f /var/log/tenant-subdomain-watcher.log</code></pre>
            ...
            <pre class="bg-slate-900 text-orange-200 text-xs p-3 rounded-lg overflow-auto"><code># Configurar subdominio de un tenant (CLI)
...
php artisan tenants:setup-subdominio la-hacienda --no-dns</code></pre>
            ...
            <pre class="bg-slate-900 text-orange-200 text-xs p-3 rounded-lg overflow-auto"><code>cd /srv/proyectopedidoshacienda
git pull
...
docker compose exec pedidos_hacienda_app php artisan view:cache</code></pre>
        ...
        <section id="troubleshooting" class="rounded-2xl bg-white border border-slate-200 p-6 space-y-3">
            ...
            <div class="space-y-3 mt-2">
                <div class="rounded-xl border border-rose-200 bg-rose-50 p-4">
                    <div class="text-sm font-bold text-rose-700">"Domain name contains an invalid character" (certbot)</div>
                ...
                <div class="rounded-xl border border-rose-200 bg-rose-50 p-4">
                    <div class="text-sm font-bold text-rose-700">El modal se queda en "Esperando al watcher..."</div>
                    <p class="text-xs text-slate-700 mt-1">
                ...
                <div class="rounded-xl border border-rose-200 bg-rose-50 p-4">
                    <div class="text-sm font-bold text-rose-700">Spatie\Permission\PermissionRegistrar does not exist</div>
                    <p class="text-xs text-slate-700 mt-1">
                ...
                <div class="rounded-xl border border-rose-200 bg-rose-50 p-4">
                    <div class="text-sm font-bold text-rose-700">Super-admin ve datos mezclados de varios tenants</div>
                    <p class="text-xs text-slate-700 mt-1">
                ...
                <div class="rounded-xl border border-rose-200 bg-rose-50 p-4">
                    <div class="text-sm font-bold text-rose-700">Hostinger API: 401 Unauthorized</div>
                    <p class="text-xs text-slate-700 mt-1">
        ...
        <div class="text-center text-xs text-slate-400 pt-6">
            Última actualización: {{ now()->format('d/m/Y') }} · TecnoByte360 SaaS Platform · Documentación interna
        </div>
    </div>
</div>
