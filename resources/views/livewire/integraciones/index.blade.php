                        ...
                        @if($exporta_pedidos)
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="export_bodega"
                                           class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm font-mono"
                                           placeholder="ej: 41 o BOD01 o {variable}">
                                    <p class="text-[10px] text-slate-500 mt-1">Acepta texto/número o variable como <code>{cliente.bodega}</code></p>
                                </div>
