        ...
        $sectionsRaw = [
            ...
            [
                ...
                'items' => [
                    ...
                    ['name' => 'Llamadas Meta',     'icon' => 'fa-phone',              'route' => 'monitoreo.llamadas',     'badge' => 'NUEVO', 'permission' => 'bot.configurar', 'solo_super_admin' => true],
                    ['name' => 'Costos Meta',       'icon' => 'fa-coins',              'route' => 'monitoreo.costos-meta',  'badge' => 'NUEVO', 'permission' => 'bot.configurar', 'solo_super_admin' => true],
            ...
            [
                ...
                'items' => [
                    ...
                    ['name' => 'Asistente SAP',     'icon' => 'fa-plug-circle-bolt',   'route' => 'sap.admin',                   'badge' => 'NUEVO', 'permission' => 'tenants.gestionar', 'solo_super_admin' => true],
                    ...
                    ['name' => 'Informes negocio',  'icon' => 'fa-envelope-circle-check','route' => 'configuracion.informes-negocio','badge' => 'NUEVO', 'permission' => 'bot.configurar', 'solo_super_admin' => true],
