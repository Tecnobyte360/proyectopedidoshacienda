...
<head>
    ...
    <title><i class="fa-solid fa-rocket"></i> Pedidos | Tecnobyte</title>
    ...
    @php
        // Branding: si hay tenant impersonado/activo, sus colores y favicon.
        // Si NO, usa los de ConfiguracionPlataforma (TecnoByte360 dueño SaaS).
        ...
        // Si no hay favicon subido, generamos uno SVG inline con la inicial del brand
        if (!$faviconUrl) {
...
<body class="bg-[#f7f7f9] text-slate-800 antialiased">
    ...
    <style>
        ...
        .swal2-confirm { background: linear-gradient(135deg, #d68643, #a85f24) !important; font-weight: 700 !important; border-radius: 12px !important; padding: 10px 24px !important; }
        .swal2-cancel { background: #e2e8f0 !important; color: #475569 !important; font-weight: 600 !important; border-radius: 12px !important; padding: 10px 24px !important; }
    </style>
    <script>
        (function () {
