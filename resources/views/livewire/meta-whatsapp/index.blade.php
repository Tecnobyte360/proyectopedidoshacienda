        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
            ...
            @if($prueba_modo === 'texto')
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 mt-1">⚠️ Solo funciona si el cliente escribió en las últimas 24h (Meta lo exige).</p>
                </div>
            @else
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        @foreach($prueba_variables as $idx => $valor)
                            <div class="flex items-center gap-2">
                                <span class="text-xs font-mono text-slate-500 w-12">{{ '{{'.$idx.'}}' }}</span>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden max-h-[95vh] flex flex-col">
                ...
                <div class="p-5 space-y-3 overflow-y-auto">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-slate-700 mb-1">Body (con placeholders {{ '{{1}}' }}, {{ '{{2}}' }}, etc.)</label>
