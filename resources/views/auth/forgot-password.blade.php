...
<head>
    ...
    <style>
        ...
        :root { --brand: {{ $colorPrim }}; --brand-dark: {{ $colorSec }}; }
    ...
    <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-slate-500 mt-1">Te enviaremos un enlace para restablecerla.</p>
            </div>

            @if(session('status'))
                <div class="rounded-xl bg-emerald-50 border border-emerald-200 p-4 mb-5 text-sm text-emerald-700 flex items-start gap-2">
            ...
            <div class="mt-6 text-center">
                <a href="/login" class="text-sm text-slate-500 hover:text-slate-800 font-semibold">
